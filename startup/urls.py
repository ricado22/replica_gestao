...
urlpatterns = [
    ...
    # GET /funcionarios
    path('funcionarios/', views.HomeFuncionarioView.as_view(),
         name="index_funcionarios"),

    # GET /funcionarios/cadastrar
    path('funcionarios/cadastrar', views.CriaFuncionarioView.as_view(),
         name="cadastra_funcionario"),

    # GET /funcionarios
    path('funcionarios/lista', views.ListaFuncionariosView.as_view(),
         name="lista_funcionarios"),

    # GET/POST /funcionarios/{pk}
    path('funcionarios/<pk>', views.AtualizaFuncionarioView.as_view(),
         name="atualiza_funcionario"),

    # GET/POST /funcionarios/excluir/{pk}
    path('funcionarios/excluir/<pk>',
         views.DeletaFuncionarioView.as_view(), name="deleta_funcionario"),

    # GET /produtos
    path('produtos/', views.HomeProdutoView.as_view(), name="index_produtos"),

    # GET /produtos/cadastrar
    path('produtos/cadastrar', views.CriaProdutoView.as_view(),
    ...
    path('produtos/excluir/<pk>',
         views.DeletaProdutoView.as_view(), name="deleta_produto"),
